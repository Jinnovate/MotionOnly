...
export const libraryContent = [
  ...
  {
    id: "trading-community-compliance",
    title: "Trading Content and Community Standard",
    category: "Trading",
    type: "Community policy",
    level: "Core",
    minutes: 11,
    summary: "Share trading education and review responsibly without turning the community into a signal room or financial promotion funnel.",
